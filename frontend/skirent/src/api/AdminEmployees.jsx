...
import { getAdminUsers, blockUser, unblockUser } from "../../api/adminUsersApi";
    ...
    <div className="max-w-6xl mx-auto">
      <div className="flex items-end justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Block/unblock employees</p>
        </div>
                  ...
                  <div className="flex gap-2 justify-end">
                    {u.role === "admin" ? (
                      ...
                      <button
                        ...
                        className="px-3 py-2 text-sm rounded-lg bg-red-100 text-red-700 hover:bg-red-200 transition disabled:opacity-50"
                        type="button"
                      >
                      ...
                      <button
                        ...
                        disabled={busyId === u.id}
                        className="px-3 py-2 text-sm rounded-lg bg-green-100 text-green-700 hover:bg-green-200 transition disabled:opacity-50"
                        type="button"
                      >
